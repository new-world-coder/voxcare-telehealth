package com.pulsecare.telehealth.service;
...
import com.pulsecare.telehealth.model.TelehealthSession;
import com.pulsecare.telehealth.repository.TelehealthSessionRepository;
...
public class TelehealthService {
    ...
    private String generateRoomId(Long appointmentId) {
        return "pulsecare-" + appointmentId + "-" + UUID.randomUUID().toString().substring(0, 8);
    }
